...
function buildContentionTables(model) {
...
buildContentionTables(MODEL_48K);

export const MODEL_128K = {
  id: '128k',
  name: 'Spectrum 128K',
...
buildContentionTables(MODEL_128K);
